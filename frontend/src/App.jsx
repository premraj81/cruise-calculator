...
function App() {
  ...
  return (
    <div className="App" style={{ height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden', backgroundColor: '#f8fafc' }}>
      ...
      <div className="content-area" style={{ flex: 1, width: '100%', maxWidth: '1600px', margin: '0 auto', overflow: currentView === 'tides' ? 'hidden' : 'auto', padding: currentView === 'tides' ? '0' : '0 1rem 1rem 1rem' }}>
        {currentView === 'windows' && (
          <WindowCalculator
